...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        if (newNode == _nodes.end())
                        {
                            ...
                            //auto graphNode = std::make_unique<GraphNode>(id);
    ...
    ChatBot lclChatBot("../images/chatbot.png");
    lclChatBot.SetChatLogicHandle(this);
    lclChatBot.SetRootNode(rootNode);
    rootNode->MoveChatbotHere(std::move(lclChatBot));
